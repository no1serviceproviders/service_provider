              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div whileHover={{ scale: 1.02 }} className="md:col-span-2 backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-xl">
                  ...
                  <form onSubmit={handleFormSubmit} className="mt-4 space-y-4">
                    <input type="text" name="name" placeholder="Your name *" value={formData.name} onChange={handleInputChange} required className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 text-sm" />
                    <input type="email" name="email" placeholder="Email address *" value={formData.email} onChange={handleInputChange} required className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 text-sm" />
                    ...
                    <button type="submit" className="w-full py-2 bg-gradient-to-r from-sky-500 to-indigo-500 rounded-lg text-white font-medium hover:shadow-lg transition">Send Requirements</button>
                  </form>
                </motion.div>
